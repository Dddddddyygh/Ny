...
void *send_udp_traffic(void *arg) {
    ...
    int sock;
    char message[] = "GAA*D MARAAYII CHALU HO GAYI , AB TO CREATIVEYDV CHANNEL JOIN KAR LO";
...
int main(int argc, char *argv[]) {
    ...
    printf("Attack Start Message: GAA*D MARAAYII CHALU HO GAYI , AB TO CREATIVEYDV CHANNEL JOIN KAR LO\n");
